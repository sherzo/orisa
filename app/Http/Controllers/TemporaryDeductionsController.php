...
class TemporaryDeductionsController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($request->empleado_id))
        {
            ...
            Flash::success('<strong> Éxito </strong> se han creado nuevas deducciones para los empleados correctamente.');
