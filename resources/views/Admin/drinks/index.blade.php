        ...
        <div class="row">
           <div class="col-lg-12">
              ...
              @include('flash::message')
                ...
                <div class="col-lg-4">
                       <a  href="{{ url('admin/bebidas/create') }}" class="btn btn-primary">
              ...
              <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-body">
                    <img src="../img/drinks/{{ $drink->image->imagen }}" alt="" class="img-responsive">
                  </div>
...
<!--               <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  <img src="../img/drinks/{{ $drink->image->nombre }}" >
                  <div class="caption">
                    <h4>{{ $drink->plato }}</h4>
